#include "GOL_AN5D_16386_kernel.hu"
...
#define AN5D_TYPE unsigned
    ...
    #define __CALCEXPR(__rn0, __a, __b, __c) do { __rn0 = rule_table[grid[((c0 % 2) * 16386 + c1) * 16386 + c2] * 9 + (grid[((c0 % 2) * 16386 + (c1 - 1)) * 16386 + c2] + grid[((c0 % 2) * 16386 + (c1 + 1)) * 16386 + c2] + grid[((c0 % 2) * 16386 + c1) * 16386 + (c2 - 1)] + grid[((c0 % 2) * 16386 + c1) * 16386 + (c2 + 1)] + grid[((c0 % 2) * 16386 + (c1 - 1)) * 16386 + (c2 - 1)] + grid[((c0 % 2) * 16386 + (c1 - 1)) * 16386 + (c2 + 1)] + grid[((c0 % 2) * 16386 + (c1 + 1)) * 16386 + (c2 - 1)] + grid[((c0 % 2) * 16386 + (c1 + 1)) * 16386 + (c2 + 1)])]; } while (0)
