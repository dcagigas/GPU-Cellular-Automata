...
#define cudaCheckKernel() \
  do { \
    cudaCheckReturn(cudaGetLastError()); \
      ...
      cudaCheckReturn(cudaMalloc((void **) &dev_grid, (size_t)(2) * (size_t)(16386) * (size_t)(16386) * sizeof(char)));
      cudaCheckReturn(cudaMalloc((void **) &dev_rule_table, (size_t)(2) * (size_t)(9) * sizeof(char)));
      
{
      cudaCheckReturn(cudaMemcpy(dev_grid, grid, (size_t)(2) * (size_t)(16386) * (size_t)(16386) * sizeof(char), cudaMemcpyHostToDevice));
#ifdef STENCILBENCH
...
SB_STOP_INSTRUMENTS;
#endif
      cudaCheckReturn(cudaMemcpy(grid, dev_grid, (size_t)(2) * (size_t)(16386) * (size_t)(16386) * sizeof(char), cudaMemcpyDeviceToHost));
}
