...
#define cudaCheckKernel() \
  do { \
    cudaCheckReturn(cudaGetLastError()); \
      ...
      cudaCheckReturn(cudaMalloc((void **) &dev_grid, (size_t)(2) * (size_t)(514) * (size_t)(514) * sizeof(char)));
      cudaCheckReturn(cudaMalloc((void **) &dev_rule_table, (size_t)(2) * (size_t)(9) * sizeof(char)));
      
{
      cudaCheckReturn(cudaMemcpy(dev_grid, grid, (size_t)(2) * (size_t)(514) * (size_t)(514) * sizeof(char), cudaMemcpyHostToDevice));
#ifdef STENCILBENCH
...
SB_STOP_INSTRUMENTS;
#endif
      cudaCheckReturn(cudaMemcpy(grid, dev_grid, (size_t)(2) * (size_t)(514) * (size_t)(514) * sizeof(char), cudaMemcpyDeviceToHost));
}
