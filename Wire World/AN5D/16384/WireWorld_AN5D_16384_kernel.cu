...
__global__ void kernel0_4(char *grid, char *lookup_table, int c0)
{
#ifndef AN5D_TYPE
#define AN5D_TYPE unsigned
    ...
    #define __LOAD(reg, h) do { if (__loadValid) { __c1 = __c1Pad2 - __halo1 + h; reg = grid[((__c0 % 2) * 16384 + __c1) * 16384 + __c2]; }} while (0)
    #define __DEST (grid[(((c0 + 1) % 2) * 16384 + c1) * 16384 + c2])
    #define __REGREF(reg, i2) reg
    #define __SBREF(sb, i2) __sbref_wrap(sb, (int)__tid + i2)
    #define __CALCEXPR(__rn0, __a, __b, __c) do { __rn0 = lookup_table[grid[((c0 % 2) * 16384 + c1) * 16384 + c2] * 137 + (grid[((c0 % 2) * 16384 + (c1 - 1)) * 16384 + c2] + grid[((c0 % 2) * 16384 + (c1 + 1)) * 16384 + c2] + grid[((c0 % 2) * 16384 + c1) * 16384 + (c2 - 1)] + grid[((c0 % 2) * 16384 + c1) * 16384 + (c2 + 1)] + grid[((c0 % 2) * 16384 + (c1 - 1)) * 16384 + (c2 - 1)] + grid[((c0 % 2) * 16384 + (c1 - 1)) * 16384 + (c2 + 1)] + grid[((c0 % 2) * 16384 + (c1 + 1)) * 16384 + (c2 - 1)] + grid[((c0 % 2) * 16384 + (c1 + 1)) * 16384 + (c2 + 1)])]; } while (0)
...
__global__ void kernel0_3(char *grid, char *lookup_table, int c0)
{
#ifndef AN5D_TYPE
#define AN5D_TYPE unsigned
#endif
...
__global__ void kernel0_2(char *grid, char *lookup_table, int c0)
{
#ifndef AN5D_TYPE
#define AN5D_TYPE unsigned
#endif
...
__global__ void kernel0_1(char *grid, char *lookup_table, int c0)
{
#ifndef AN5D_TYPE
#define AN5D_TYPE unsigned
#endif
