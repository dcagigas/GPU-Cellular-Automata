...
#define AN5D_TYPE unsigned
    ...
    #define __LOAD(reg, h) do { if (__loadValid) { __c1 = __c1Pad2 - __halo1 + h; reg = grid[((__c0 % 2) * 4096 + __c1) * 4096 + __c2]; }} while (0)
    #define __DEST (grid[(((c0 + 1) % 2) * 4096 + c1) * 4096 + c2])
    #define __REGREF(reg, i2) reg
    #define __SBREF(sb, i2) __sbref_wrap(sb, (int)__tid + i2)
    #define __CALCEXPR(__rn0, __a, __b, __c) do { __rn0 = lookup_table[grid[((c0 % 2) * 4096 + c1) * 4096 + c2] * 137 + (grid[((c0 % 2) * 4096 + (c1 - 1)) * 4096 + c2] + grid[((c0 % 2) * 4096 + (c1 + 1)) * 4096 + c2] + grid[((c0 % 2) * 4096 + c1) * 4096 + (c2 - 1)] + grid[((c0 % 2) * 4096 + c1) * 4096 + (c2 + 1)] + grid[((c0 % 2) * 4096 + (c1 - 1)) * 4096 + (c2 - 1)] + grid[((c0 % 2) * 4096 + (c1 - 1)) * 4096 + (c2 + 1)] + grid[((c0 % 2) * 4096 + (c1 + 1)) * 4096 + (c2 - 1)] + grid[((c0 % 2) * 4096 + (c1 + 1)) * 4096 + (c2 + 1)])]; } while (0)
