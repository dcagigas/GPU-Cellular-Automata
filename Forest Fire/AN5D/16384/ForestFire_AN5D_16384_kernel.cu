#include "ForestFire_AN5D_16384_kernel.hu"
__device__ unsigned char __sbref_wrap(unsigned char *sb, size_t index) { return sb[index]; }

__global__ void kernel0_4(unsigned char *grid, unsigned char *lookup_table, int c0)
{
#ifndef AN5D_TYPE
#define AN5D_TYPE unsigned
    ...
    #define __c0 c0
    const AN5D_TYPE __c1Len = (16384 - 1 + 1);
    const AN5D_TYPE __c1Pad = (1);
    #define __c1 c1
    const AN5D_TYPE __c2Len = (16384 - 1 + 1);
    ...
    unsigned char __reg_0_0;
    unsigned char __reg_0_1;
    unsigned char __reg_0_2;
    unsigned char __reg_1_0;
    unsigned char __reg_1_1;
    unsigned char __reg_1_2;
    unsigned char __reg_2_0;
    unsigned char __reg_2_1;
    unsigned char __reg_2_2;
    unsigned char __reg_3_0;
    unsigned char __reg_3_1;
    unsigned char __reg_3_2;
    __shared__ unsigned char __b_sb_double[__blockSize * 2];
    unsigned char *__b_sb = __b_sb_double;
    ...
    #define __LOAD(reg, h) do { if (__loadValid) { __c1 = __c1Pad2 - __halo1 + h; reg = grid[((__c0 % 2) * 16386 + __c1) * 16386 + __c2]; }} while (0)
    #define __DEST (grid[(((c0 + 1) % 2) * 16386 + c1) * 16386 + c2])
    #define __REGREF(reg, i2) reg
    #define __SBREF(sb, i2) __sbref_wrap(sb, (int)__tid + i2)
    #define __CALCEXPR(__rn0, __a, __b, __c) do { __rn0 = lookup_table[grid[((c0 % 2) * 16386 + c1) * 16386 + c2] * 37 + (grid[((c0 % 2) * 16386 + (c1 - 1)) * 16386 + c2] + grid[((c0 % 2) * 16386 + (c1 + 1)) * 16386 + c2] + grid[((c0 % 2) * 16386 + c1) * 16386 + (c2 - 1)] + grid[((c0 % 2) * 16386 + c1) * 16386 + (c2 + 1)])]; } while (0)
...
__global__ void kernel0_3(unsigned char *grid, unsigned char *lookup_table, int c0)
{
#ifndef AN5D_TYPE
#define AN5D_TYPE unsigned
#endif
...
__global__ void kernel0_2(unsigned char *grid, unsigned char *lookup_table, int c0)
{
#ifndef AN5D_TYPE
#define AN5D_TYPE unsigned
#endif
...
__global__ void kernel0_1(unsigned char *grid, unsigned char *lookup_table, int c0)
{
#ifndef AN5D_TYPE
#define AN5D_TYPE unsigned
#endif
